            ...
            >
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-700 mb-1">
                  ...
                  {alerta.mensagem ||
                    "Inconsistência detectada entre OUT/IN e quantidade de fichas."}
                </div>
                <div className="text-xs text-gray-500">
                  <span className="font-bold">OUT registrado:</span>{" "}
                  {alerta.contador_out} |{" "}
                  <span className="font-bold">IN registrado:</span> {alerta.contador_in}{" "}
      ...
      >
        ...
        {alertaSelecionado && (
          <div>
            ...
            <div className="mb-2">OUT: {alertaSelecionado.contador_out}</div>
            <div className="mb-2">IN: {alertaSelecionado.contador_in}</div>
