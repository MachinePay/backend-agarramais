  ...
  const resposta = await fetch(OPENAI_RESPONSES_URL, {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "PRIORIDADE DE EMPACOTAMENTO - entre usar poucas caixas grandes ou varias caixas pequenas, de SEMPRE preferencia a usar a MAIOR quantidade possivel de volumes com as MENORES caixas do catalogo que ainda comportem os itens com folga. Ou seja: prefira dividir o pedido em varias unidades da menor caixa possivel em vez de usar uma ou poucas caixas grandes. So suba para uma caixa maior quando a menor nao for capaz de comportar nem um subconjunto razoavel dos itens (ex: um item individual maior que a menor caixa, ou a quantidade de volumes ficaria absurdamente alta).",
        "Quando nenhuma caixa do catalogo sozinha comportar tudo, prefira dividir em varias unidades da MESMA caixa pequena (explique a divisao no campo itensAlocados) em vez de trocar para uma caixa maior.",
